...
// GP model interface
    ...
    jl_function_t* test_model = jl_get_function(jl_main_module, "test_model");
    ...
    jl_value_t *tsmodel = jl_call2(load_tsmodel, jl_model_file, jl_data_record);

    jl_value_t *model = jl_call1(test_model, tsmodel);
